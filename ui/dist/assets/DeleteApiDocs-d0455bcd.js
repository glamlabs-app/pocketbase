import{S as Ce,i as Re,s as Ee,e as r,w as $,b as h,c as $e,f as m,g as f,h as n,m as we,x,aa as _e,ab as Pe,k as Te,ac as Be,n as Oe,t as ee,a as te,o as u,d as ge,ae as Ie,C as Ae,p as Me,r as z,u as Se,a9 as qe}from"./index-7c20673d.js";import{S as He}from"./SdkTabs-9d65f898.js";function ke(o,l,s){const a=o.slice();return a[6]=l[s],a}function he(o,l,s){const a=o.slice();return a[6]=l[s],a}function ve(o){let l;return{c(){l=r("p"),l.innerHTML="Requires admin <code>Authorization:TOKEN</code> header",m(l,"class","txt-hint txt-sm txt-right")},m(s,a){f(s,l,a)},d(s){s&&u(l)}}}function ye(o,l){let s,a=l[6].code+"",v,i,c,p;function w(){return l[5](l[6])}return{key:o,first:null,c(){s=r("button"),v=$(a),i=h(),m(s,"class","tab-item"),z(s,"active",l[2]===l[6].code),this.first=s},m(b,g){f(b,s,g),n(s,v),n(s,i),c||(p=Se(s,"click",w),c=!0)},p(b,g){l=b,g&20&&z(s,"active",l[2]===l[6].code)},d(b){b&&u(s),c=!1,p()}}}function De(o,l){let s,a,v,i;return a=new qe({props:{content:l[6].body}}),{key:o,first:null,c(){s=r("div"),$e(a.$$.fragment),v=h(),m(s,"class","tab-item"),z(s,"active",l[2]===l[6].code),this.first=s},m(c,p){f(c,s,p),we(a,s,null),n(s,v),i=!0},p(c,p){l=c,(!i||p&20)&&z(s,"active",l[2]===l[6].code)},i(c){i||(ee(a.$$.fragment,c),i=!0)},o(c){te(a.$$.fragment,c),i=!1},d(c){c&&u(s),ge(a)}}}function Le(o){var ue,pe;let l,s,a=o[0].name+"",v,i,c,p,w,b,g,q=o[0].name+"",F,le,K,C,N,T,G,y,H,se,L,P,oe,J,U=o[0].name+"",Q,ae,V,ne,W,B,X,O,Y,I,Z,R,A,D=[],ie=new Map,ce,M,_=[],re=new Map,E;C=new He({props:{js:`
