import{S as $t,i as Ot,s as Mt,C as E,a9 as St,e as r,w as y,b as m,c as be,f as T,g as a,h as i,m as me,x as U,aa as je,ab as mt,k as qt,ac as Dt,n as Ht,t as de,a as re,o,d as _e,ae as Rt,p as Lt,r as ye,u as Pt,y as X}from"./index-7c20673d.js";import{S as Ft}from"./SdkTabs-9d65f898.js";import{F as At}from"./FieldsQueryParam-f0c977d6.js";function _t(f,t,l){const s=f.slice();return s[7]=t[l],s}function yt(f,t,l){const s=f.slice();return s[7]=t[l],s}function kt(f,t,l){const s=f.slice();return s[12]=t[l],s}function ht(f){let t;return{c(){t=r("p"),t.innerHTML="Requires admin <code>Authorization:TOKEN</code> header",T(t,"class","txt-hint txt-sm txt-right")},m(l,s){a(l,t,s)},d(l){l&&o(t)}}}function vt(f){let t,l,s,b,u,d,p,k,C,w,$,R,F,N,O,g,A;return{c(){t=r("tr"),t.innerHTML='<td colspan="3" class="txt-hint">Auth fields</td>',l=m(),s=r("tr"),s.innerHTML=`<td><div class="inline-flex"><span class="label label-warning">Optional</span> 
